...
public enum SubtitleTimingValidator {
    public static let minimumDurationMs = 500
    public static let minimumGapMs = 50

    public static func resizeSegment(
    ...
    public static func updateSegmentTiming(
        segments: [SubtitleSegment],
        id: UUID,
        startMs: Int,
        endMs: Int,
    ...
    public static func reindexed(_ segments: [SubtitleSegment]) -> [SubtitleSegment] {
