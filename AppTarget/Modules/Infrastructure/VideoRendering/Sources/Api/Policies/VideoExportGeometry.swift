...
public enum VideoExportGeometry {
    ...
    public static func availableResolutions(
        sourceWidth: Int,
        sourceHeight: Int
    ...
    public static func availableFrameRates(
    ...
    public static func aspectFitRect(videoSize: CGSize, in bounds: CGRect) -> CGRect {
