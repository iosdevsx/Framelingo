...
public struct ShortsSuggestionService {
    public var silenceGapThresholdMs = 1_500
    /// Close a candidate once it reaches this fraction of the platform limit.
    public var targetFractionOfLimit = 0.5
    /// Ignore trailing candidates shorter than this.
    public var minimumSuggestionDurationMs = 5_000
