...
public struct AppSettings: Codable, Equatable {
    public var speechToTextProviderName: String
    public var translationProviderName: String
    public var ffmpegPath: String
    public var whisperExecutablePath: String
    public var whisperModelName: String
    public var whisperModelPath: String
    public var whisperVADModelPath: String
    ...
    public var subtitleMaxLines: Int
